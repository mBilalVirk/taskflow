<div class="max-w-2xl bg-white border border-slate-100 rounded-xl shadow-sm p-6 relative mt-6"
    ...
    <form wire:submit="updatePassword" class="space-y-5">
        ...
        <!-- Current Password -->
        <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-2">Current Password</label>
            <div class="relative">
        ...
        <!-- New Password -->
        <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-2">New Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
        ...
        <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-2">Confirm New
                Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
